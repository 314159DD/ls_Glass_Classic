...
L["EDITBOX"] = "Edit Box"
L["PRAT_EDITBOX_WARNING"] = "|cffff7f7fPrat's Editbox module is controlling the chat input box, so the settings below have no effect. Disable it in Prat under Modules to hand control back to LS: Glass.|r"
